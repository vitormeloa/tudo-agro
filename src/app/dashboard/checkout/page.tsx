      ...
      <AdminLayout>
        <div className="min-h-screen bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            {/* Header */}
            <div className="mb-8">
              <Link href="/dashboard/carrinho" className="inline-flex items-center text-gray-600 hover:text-green-600 mb-4">
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="space-y-2 pt-4 border-t">
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="text-gray-900">R$ {getSubtotal().toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                        </div>
                        <div className="flex justify-between text-sm">
                        ...
                        <div className="flex justify-between text-lg font-bold pt-2 border-t">
                          <span>Total</span>
                          <span className="text-green-600">R$ {getTotal().toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                        </div>
                      </div>
