      ...
      <AdminLayout>
        <div className="min-h-screen bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            {/* Header */}
            <div className="mb-6">
              <Link href="/dashboard/produtos" className="inline-flex items-center text-gray-600 hover:text-green-600 mb-4">
                    ...
                    >
                      <CardContent className="p-4 sm:p-6">
                        <div className="flex flex-col sm:flex-row gap-4">
                          {/* Imagem */}
                          <Link href={item.type === 'product' ? `/dashboard/produtos/${item.id}` : `/dashboard/catalogo/${item.id}`}>
                          ...
                          <div className="flex-1 flex flex-col sm:flex-row sm:justify-between gap-4">
                            <div className="flex-1">
                              <Link 
                                href={item.type === 'product' ? `/dashboard/produtos/${item.id}` : `/dashboard/catalogo/${item.id}`}
