          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="border-2 border-gray-200">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold text-[#101828] mb-2">Buscar</h3>
            ...
            <Card className="border-2 border-gray-200">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold text-[#101828] mb-2">Negociar</h3>
            ...
            <Card className="border-2 border-gray-200">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold text-[#101828] mb-2">Comprar</h3>
              ...
              <Card key={index} className="border-2 border-amber-200 bg-amber-50">
                <CardContent className="p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-[#101828]">{warning.title}</h3>
                  </div>
